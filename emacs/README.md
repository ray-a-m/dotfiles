...
| `C-c w` | window menu: split / `t` fresh right split showing the splash (vim `:tabnew` feel) / pick-file-into-split (`f` right, `b` below) / swap / repeatable divider drag (`hjkl`) / winner undo |
